...
class LLMProvider:
    ...
    def label_cluster(self, titles, lang="es"):
        prompt = f"""Resume en 1 línea el tema común de estas noticias (idioma: {lang}):
Títulos: {titles[:5]}
Tema:"""
...
Idioma: {lang}"""
    ...
    def detect_editorial_angle(self, article_titles):
        prompt = f"""Identifica si estas noticias son editoriales coordinados o ángulos independientes:
